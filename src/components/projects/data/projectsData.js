...
const projectData = [
...

  {
    ...
    image: img4,
    name: "Golf Stats",
    description: `I’m Building a full-stack web app that allows users to track their golf club stats. This app uses a RESTful API so users can view create delete update stats on each golf club they own. It uses MongoDB for storing users club data. 
    `,
    demo: true,
