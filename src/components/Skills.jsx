...
const Skills = () => {
  return (
    <div name='skills' className='w-full bg-[#0a192f] text-gray-300 py-[100px] lg:py-[300px] flex justify-center items-center'>
      {/* Container */}
      <div className='lg:max-w-[1000px] xl:max-w-[1110px] 2xl:max-w-[1400px] pb-[50px] px-5 lg:px-0 mx-auto flex flex-col w-full'>
        ...
        <div className=' w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
          <div className='hover:bg-[#061a38] p-2 flex flex-col justify-center items-center w-[200px] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <img className='w-20'src={HTML} alt='' />
            <p className='mt-4'>HTML</p>
          </div>
          <div className='hover:bg-[#061a38] p-4 flex flex-col justify-center items-center w-[200px] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
